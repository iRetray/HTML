...
<body>
		<table class="table" align="center">
			<tr><td><p class="texto">Notas de sus Estudiantes</p></td></tr>
			<tr><td><p class="texto2">Aqui puedes conocer a que usuario debes asignar ciertas notas</p></td></tr>
			<tr class="tr1">
				<td><p class="texto1">
...
?>
		...
		<br>
		<form action="profesorHome.php" method="get">
